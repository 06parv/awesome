-- From https://github.com/streetturtle/AwesomeWM/blob/master/battery-widget/battery.lua
...
function show_battery_warning()
    naughty.notify{
    icon = "/home/gagaro/.config/awesome/arc-icon-theme/Arc/status/128/dialog-warning.png",
    icon_size=100,
